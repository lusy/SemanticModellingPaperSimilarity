...
Dafür wurde ein Publikationsnetzwerk aufgestellt, das die im Datensatz beinhalteten Publikationen und deren Metadaten als Knoten modelliert.
Der Algorithmus für semantische Ähnlichkeit hat rekursiv anhand des gesamten Netzwerks die Ähnlichkeit zwischen jeden zwei Publikationen berechnet.
Dabei wurde aus der Intuition ausgegangen, dass zwei Publikationen ähnlich sind, wenn sie ähnliche Metadaten haben.
\\
\\
Die experimentellen Ergebnisse haben gezeigt, dass sich das semantische Ähnlichkeitsmaß besser für die Ähnlichkeitsberechnung zweier Publikationen als das strukturelle Maß \textit{C-Rank}, das nur auf Zitationen basiert, eignet.
