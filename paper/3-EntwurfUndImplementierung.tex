...
Diese modelliert die folgenden Klassen: ... und auch die entsprechenden, in der Regel invertierbaren, Beziehungen zwischen diesen Klassen (z.B. die Paare: hasAuthor - isAuthorOf, hasClassificationCode - isClassificationCodeOf, etc.).
