...
Eine Verteilung der Autorenzahlen im $zmath$-Datensatz ist auf Abbildung \ref{fig:authorFreq} zu sehen\footnote{Publikationen, bei denen die Anzahl der Autoren, Zitationen, Keywords oder MSC-Klassen null ist, werden in den Diagrammen nicht berücksichtigt}.
\\
\\
...
\\
\\
Die bereits existierende \textit{Ontology of Science} \cite{ontosci} (vgl. Kapitel \ref{sec:semanticRepr}) scheint auf den ersten Blick ein gutes Modell für Publikationen zu sein, hat jedoch einen ganz anderen Fokus.
...
% Um ein Gefühl dafür zu bekommen, wie der Algorithmus funktioniert, werden hier die ersten Schritte, die für die Ähnlichkeitsberechnung folgender zwei Publikationen aus dem \textit{zmath}-Datensatz notwendig sind, ausgeführt . -- siehe Anhang
