...
Eines der Ziele dieser Arbeit war, eine Modellierung wissenschaftlicher Publikationen und dazu gehöriger Metadaten in der Form eines semantischen Netzes zu schaffen.
Im zweiten Teil der Arbeit soll dann von dieser semantischen Repräsentation profitiert werden, indem möglichst viele verschiedene Metadaten für die Ermittlung der Ähnlichkeit zwischen zwei Publikationen berücksichtigt werden.
\\
\\
...
Aus diesen Gründen schlägt die aktuelle Arbeit eine neue \textit{Publications Ontology} vor.
...
In Abbildung \ref{fig:pubsOnto} sind alle Klassen mit den dazugehörigen Unterklassen und die dazwischen herrschenden Beziehungen zu sehen.
Bei den Object Properties geht es in der Regel aus deren Namen hervor, zwischen Individuen welcher zwei Klassen diese stehen:
...
\\
\\
Eine andere auffällige Besonderheit ist die Tatsache, dass sowohl die Klasse \textit{Title}, die mittels der Object Property \textit{hasTitle} mit der Klasse \textit{Publication} verbunden ist, als auch das Data Property \textit{hasTitleString} modelliert werden.
...
\\
\\
Die Motivation hierfür ist ein sparsamerer Umgang mit Ressourcen.
...
\\
\\
Analog zu den schon erwähnten Arbeiten, die strukturelle Ähnlichkeitsmaße für Informationsnetzwerke definieren, basiert das vorgeschlagene semantische Maß auch auf der Idee ``zwei Objekte sind ähnlich, wenn sie mit ähnlichen Objekten verbunden sind''.
Es wird rekursiv die Ähnlichkeit zwischen je 2 Elementen einer Klasse aufgrund der Relationen im modellierten semantischen Netz für wissenschaftliche Publikationen ermittelt: je 2 Publikationen, je 2 Keywords, je 2 Autoren, je 2 Quellen und je 2 Erscheinungsjahren.
...
Bei der Ähnlichkeitsberechnung für 2 Elemente jeder anderen Klasse werden nur die Beziehungen zwischen Elementen der entsprechenden Klasse und Publikationen berücksichtigt, da nur solche Beziehungen im vorgeschlagenen semantischen Netz modelliert sind.
...
Diese reduzierten Datensätze beinhalten $1,154,950$ Publikationen.
