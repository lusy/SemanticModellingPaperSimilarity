...
\\
\\
Eine andere auffällige Besonderheit ist die Tatsache, dass sowohl die Klasse \textit{Title} als auch die Data Property \textit{hasTitleString} modelliert werden.
% zukünftige Möglichkeiten der Auswertung (Abstract, Title können auch nach weiterer Verabeitung ausgewertet werden) - mehr dazu in Evaluation oder Ausblick
\\
\\
