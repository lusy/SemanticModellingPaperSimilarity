...
Die bereits existierende $Ontology of Science$ \cite{ontosci} scheint auf dem ersten Blick einen ähnlichen Zweck zu erfüllen, hat jedoch einen ganz anderen Fokus.
...
Sie bietet ferner eine recht detaillierte Aufteilung von wissenschaftlichen Publikationen.
...
Viele Einheiten, die für solche Analysen von großem Interesse wären, werden durch die $Ontology of Science$ nicht erfasst.
