...
Die \textit{Publications Ontology} hat die Form eines semantischen Netzes, das mit Hilfe der Ontologiebeschreibungssprache \textit{OWL} definiert wird.
...
Alle allgemeinen Kategorien (Publikation, Autor, Quele, etc.) werden dabei als Klassen definiert.
...
\\
\\
%was sind individuen, was sind klassen -- vgl 2.2 Semantische Netzwerke
