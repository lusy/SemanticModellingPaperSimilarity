...
und auch die entsprechenden, in der Regel invertierbaren, Beziehungen zwischen diesen Klassen (z.B. die Paare: hasAuthor - isAuthorOf, hasClassificationCode - isClassificationCodeOf, etc.).
Ferner werden die folgenden für eine Publikation relevante Metadaten als Data Properties (?) dargestellt:
Eine vollständige Auflistung der Klassen der \textit{Publications Ontology} sowie der Object und Data Properties bieten Abbildungen xyz an.
...
Abbildung bbb zeigt nochmal die Oberklassen mit den gelabelten Beziehungen (jedoch, aus ästetischen Gründen, nur in einer Richtung).
