...
\newline
\newline
wo $K$ alle Keyword-Relationen, $A$ alle Autor-Relationen, $S$ alle Source-Relationen, $C$ alle Zitationsrelationen und $Y$ alle Erscheinungsjahrrelationen einer Publikation darstellen
\newline
\newline
$\sum_{i=1}^{5} \lambda_i = 1$ sind die Gewichtungen von den verschiedenen Relationen
\newline
\newline
$c$ ist ein Dämfungsfaktor $c\in (0,1)$
\newline
\end{mydef}
Das vorgeschlagene Maß grenzt sich folgendermaßen von früheren Arbeiten ab:
\\
\\
SimRank und rvs-SimRank \cite{simrank2002} messen allgemeine strukturelle Ähnlichkeit in Graphstrukturen, jeweils auf die ein- bzw. auf die ausgesehenden Kanten des Graphs gestützt.
\\
\\
