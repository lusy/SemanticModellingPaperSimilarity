...
Die untersuchte Problemstellung, die angewandten Methoden oder die Kombination von beiden müssen bei einer wissenschaftlichen Arbeit neu sein, damit sie in ihrem Forschungsfeld einen Mehrwert hat.
...
\\
Der Begriff $Bibliometrie$ existiert seit 1969 und ist auf A. Pritchard zurückzuführen, auch wenn die ersten bibliometrischen Analysen schon bereits am Anfang des 20. Jahrhunderts durchgeführt worden sind.
...
% die Bibliometrie ist ein Versuch Ordnung im heutigen Informationsflut zu schaffen\cite{NAB2004}
% die Bibliometrie ist quantitativ (geht nicht inhaltlich auf die Dokumente ein)
...
% gerichtete Kanten in Zitationsnetzwerke stehen auch für eine zeitliche Richtung (das zitierte Dokument muss ja älter sein als das Dokument, von dem es zitiert wird)
