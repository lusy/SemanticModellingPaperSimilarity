...
\\
\\
Algorithmus \ref{alg:derAlg} braucht im schlimmsten Fall $\mathcal{O}(n^4)$ Zeit, denn für die Ähnlichkeitsberechnung jeder zwei Knoten werden rekursiv auch alle Knotenpaare, die zu ihren Nachbarn gehören, betrachtet.
...
Also bestimmt der Wert $c^{k+1}$ die Genauigkeit, die der iterative \textit{SimRank}-Algorithmus erreicht.
