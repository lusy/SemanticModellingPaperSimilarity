...
Diese letzte Verkürzung des \textit{zmath}-Datensatzes wurde so gewählt, damit keine Zitationsrelationen zu Arbeiten, die außer Betracht bleiben, verloren gehen.
...
Das liegt an dem Wesen des vorgeschlagenen Algorithmus, der die Ähnlichkeit zwischen zwei Publikationen rekursiv aufgrund des gesamten Publikationsnetzwerksbestimmt.
Aus diesem Grund werden die berechneten Ähnlichkeitswerte für die Publikationen bis zum 1975 nicht ganz den reellen Ähnlichkeitswerten für diese Publikationen entsprechen, die sich ergeben würden, wenn der Algorithmus auf dem gesamten \textit{zmath}-Datensatz angewandt wäre.
