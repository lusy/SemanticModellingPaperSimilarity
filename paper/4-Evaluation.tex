...
Je kleiner die Entropy eines Clusters ist, desto besser ist der Cluster.
\\
\\
...
\\
\\
Tabelle \ref{tab:results} fasst die Werte dieser Metriken für die drei Parametrisierungen des semantischen Ähnlichkeitsmaßes und für \textit{C-Rank} zusammen.
...
Ferner lässt sich feststellen, dass unter den drei verschiedenen Metadatengewichtungen der semantischen Ähnlichkeit die Zweite, wobei alle Metadaten gleich gewichtet waren, am schlechtesten ist.
