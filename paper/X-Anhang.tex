\section*{\large{Appendix}}%\setcounter{section}{1}

\subsection*{Die \textit{GraphML}-Repräsentation des Testdatensatzes}

Der folgende Codeausschnitt soll die \textit{GraphML}-Repräsentation der Beispielspublikation \textit{Publication\_123456} mit ihren Autor \textit{John Smith} und zwei Keywords \textit{graph theory} und \textit{shortest path} veranschaulichen.
...
\newpage
\subsection*{\large{Berechnung des Ähnlichkeitsmaßes}}
In diesem Appendix wird die erste Iteration, die für die Berechnung der semantischen Ähnlichkeit erfoderlich ist, für zwei Publikationen aus dem \textit{zmath}-Datensatz beispielhaft durchgeführt.
...
\begin{tabular}{l l}
        ...
        :au: & Myrberg, P.J.\\
        :ai: & myrberg.pekka-j\\
        :ti: & Über beschränkte Funktionen in mehrfach zusammenhängenden Bereichen.\\
...
\bigskip
Dieser erste Iterationsschritt wird auch für alle Kombinationen aus jeweils zwei Keywords, zwei Autoren, zwei Quellen und zwei Erscheinungsjahre ausgeführt.
Für jedes Paare derselben Klasse (z.B. zwei Keywords) wird die Ähnlichkeit nach der folgenden Formel bestimmt.
Dabei sind L(a) die Publikationen, die das Keyword $a$ verwenden.
Es kann hier leider kein wahrheitsgetreuer Iterationsschritt für Keywords beispielhaft vorgeführt werden, da wir dafür alle Publikationen im Datensatz, die diese Keywords verwenden, raussuchen sollten.
Ein Anfang der Ähnlichkeitsberechnung für die Keywords \textit{complex functions} und \textit{Fourier series} wird folgendermaßen aussehen.
\medskip
...
\newpage
\subsection*{\large{Diagramme}}
In diesem Abschnitt werden manche der verwendeten Abbildungen in größerer Version aufgeführt.
...
\newpage
\subsection*{\large{Ergebnisse des \textit{pam} Clustering}}

\begin{longtable}[H]{| l | l | l | l | l |}
%\begin{tabular}{| l | l | l | l | l |}
		\multicolumn{2}{l}{\textbf{C-Rank}} \\
		\hline
        \textbf{ClusterID} & \textbf{\# Publikationen} & \textbf{Entropy} & \textbf{Purity} & \textbf{Größte MSC Klasse}\\
	    \hline
...
\begin{longtable}[H]{| l | l | l | l | l |}
%\begin{tabular}{| l | l | l | l | l |}
		\multicolumn{2}{l}{\textbf{Gewichtung 3}} \\
		\hline
        \textbf{ClusterID} & \textbf{\# Publikationen} & \textbf{Entropy} & \textbf{Purity} & \textbf{Größte MSC Klasse}\\
	    \hline
        1 & 81 & 3.63873238815 & 0.37037037037 & 11-XX :  30 Pubs\\
        2 & 27 & 1.47843459966 & 0.518518518519 & 28-XX :  14 Pubs\\
        3 & 73 & 3.87930003148 & 0.328767123288 & 11-XX :  24 Pubs\\
        4 & 35 & 2.46004935973 & 0.514285714286 & 65-XX :  18 Pubs\\
        5 & 33 & 1.21980525052 & 0.787878787879 & 11-XX :  26 Pubs\\
        6 & 25 & 1.02631371386 & 0.8 & 62-XX :  20 Pubs\\
        7 & 69 & 3.15864569175 & 0.405797101449 & 11-XX :  28 Pubs\\
        8 & 43 & 3.57144613167 & 0.302325581395 & 11-XX :  13 Pubs\\
        9 & 71 & 3.30263703002 & 0.338028169014 & 00-XX :  24 Pubs\\
        10 & 160 & 4.6664715524 & 0.2125 & 74-XX :  34 Pubs\\
        11 & 67 & 2.48263443668 & 0.537313432836 & 11-XX :  36 Pubs\\
        12 & 41 & 2.62364843505 & 0.487804878049 & 20-XX :  20 Pubs\\
        13 & 54 & 4.00825027417 & 0.203703703704 & 11-XX :  11 Pubs\\
        14 & 17 & 1.43925401721 & 0.705882352941 & 16-XX :  12 Pubs\\
        15 & 88 & 4.67222260276 & 0.113636363636 & 11-XX :  10 Pubs\\
        16 & 39 & 1.28638669654 & 0.769230769231 & 35-XX :  30 Pubs\\
        17 & 71 & 0.750824264819 & 0.887323943662 & 60-XX :  63 Pubs\\
        18 & 174 & 2.53328294476 & 0.597701149425 & 54-XX :  104 Pubs\\
