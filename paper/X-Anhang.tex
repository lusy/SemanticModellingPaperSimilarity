...
\bigskip
Dieser erste Iterationsschritt wird auch für jede zwei Keywords, Autoren, Quellen und Erscheinungsjahre ausgeführt.
Für jede zwei Elemente der selben Klasse (z.B. zwei Keywords) wird die Ähnlichkeit nach der folgenden Formel bestimmt.
Dabei sind L(a) die Publikationen, die das Keyword $a$ verwenden.
Es kann hier leider keiner wahrheitsgetreuer Iterationsschritt für Keywords beispielhaft vorgeführt werden, da wir dafür alle Publikationen im Datensatz, die diesen Keywords verwenden, aussuchen sollten.
