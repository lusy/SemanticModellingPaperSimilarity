...
########## HandleMethods #################################################################
def publications_to_dicts(publication):
    '''Takes a publication object and converts it to a dictionary of dictionaries representation'''
    ...
    if (publication.authors != [] and publication.mscClasses != [] and publication.englishKeywords != [] and publication.citations != []):
        ...
        result[pub]={}
        #print('pub, result is', result)

        #source
        # source is never empty
        try:
            result[pub][publication.source]={'rel':'source'}
        ...
        for auth in publication.authors:
            if auth !='':
                result[pub][auth]={'rel':'author'}

        result[pub][publication.publicationYear]={'rel':'year'}

        #msc classes
        for cl in publication.mscClasses:
            result[pub][cl]={'rel':'msc_class'}

        #english keywords
        #if publication.englishKeywords != []:
        for k in publication.englishKeywords:
            result[pub][k]={'rel':'keyword'}
        ...
        if publication.citations != []:
            for ci in publication.citations:
                ...
                for c in ci_stripped:
                    pub2 = "Publication_%s" % c
                    result[pub][pub2]={'rel':'citation'}
...
def publications_to_graphml(publication):
    ...
    if (publication.authors != [] and publication.mscClasses != [] and publication.englishKeywords != [] and publication.citations != []):
        #print ('Debugging.................................')
        #print("Publication is............", publication.id)
        #print("Year is...................", publication.publicationYear)
        #print("Source is.................", publication.source)
        #print("Authros are...............", publication.authors)
        #print("MSCClasses are............", publication.mscClasses)
        #print("Keywords are..............", publication.englishKeywords)
        #print("Citations are.............", publication.citations)
...
def graphml_edge(elem1, elem2, attr, ctr):
    dec = etree.Element("edge", id = str(ctr), source = elem1, target = elem2)
...
##### parsing to dicts of dicts #########################

    p.iterate_publications(publications_to_dicts)
